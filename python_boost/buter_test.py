class Bread:
    ...
    def __str__(self):
        return f'{self.broad_color}  хлебом  {self.broad_grain}  {self.broad_yeast}'
...
class Wurst:
    ...
    def __str__(self):
        return f'с кобасой вида {self.wurst_type}'
...
class Cheese:
    ...
    def __str__(self):
        return f'с сыром вида {self.cheese_type}'
...
class Butter:
    ...
    def __str__(self):
        return f'с маслом типа {self.butter_type}'
...
class Sandwich():
    ...
    def __str__(self):
        return f'Бутер сделаннный из {self.bread} {self.wurst} {self.cheese} {self.butter}. По рецепту повоара {self.maker}'


class SandwichMaker():
    'класс SandwichMaker, который будет уметь делать бутерброды из переданных ему ингредиентов'

    # def __init__(self, sandwich_count):
    #     self.sandwich_count = sandwich_count
    #
    # def make_sandwiches(self):
    #
    #
    # def __str__(self):
    #     return f'Изготовлено {self.sandwich_count} бутер с {self.bread.__str__()}'
...
if __name__ == "__main__":
    ...
    while go_input != 'N':
        ...
        cheese_type_in = int(input('Введите 1 - для копченой колбасы, 2 - для ветчины: '))
