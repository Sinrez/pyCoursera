...
def getKeyParts(key):
    #чтобы не запоминать 2 ключа, делаем из одного два
...
def checkKeys(keyA, keyB, mode):
    # Если ключ А == 1 и при этом ключ В == 0 то в режиме шифрования шифротекст будет совпадать с
    # с исходным текстом, поэтому проверяем
    ...
    if keyA < 0 or keyB < 0 or keyB > len(SYMBOLS) - 1:
        ...
        # ключ А и размер сивольного набора дб взаимно простыми числами в мультипликативном шифре
